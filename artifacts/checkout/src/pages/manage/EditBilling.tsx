    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <p className="text-muted-foreground">
            We could not find a booking for this link. Please check your confirmation email.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        <div className="mb-8 rounded-md border border-primary/15 bg-white p-6">
          <p className="mb-2 text-xs font-extrabold uppercase tracking-[0.18em] text-primary">
            Secure invoice update
          </p>
          <h1 className="text-3xl md:text-4xl font-bold mb-3">Update billing and PO details</h1>
        ...
        {!isInvoice ? (
          <div className="border border-border bg-muted/40 rounded-md p-6 flex items-start gap-4">
          ...
          <div className="border border-amber-300 bg-amber-50 rounded-md p-6 flex items-start gap-4">
          ...
          <div className="border border-green-300 bg-green-50 rounded-md p-6 flex items-start gap-4">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
            ...
            >
              ...
              {mutation.isError && (
                <div className="flex items-start gap-2 text-red-600 bg-red-50 border border-red-200 rounded-md p-3 text-sm">
